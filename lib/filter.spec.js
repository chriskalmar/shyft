...
beforeAll(async () => {
  ...
  modelRegistry = loadModels(schema)
...
describe('filter', () => {
  ...
  describe('buildWhereQuery', () => {
    ...
    it('empty filter', () => {
      const qBuilder = connection.createQueryBuilder(storageTableNameServer, entityNameServer)
      const filter = null
    ...
    it('combined logical AND/OR filter', () => {
      const qBuilder1 = connection.createQueryBuilder(storageTableNameServer, entityNameServer)
      ...
      const qBuilder2 = connection.createQueryBuilder(storageTableNameServer, entityNameServer)
