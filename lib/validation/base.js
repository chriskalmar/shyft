...
export const schemaDefinitions = {
  ...
  typeAttribute: {
    ...
    properties: {
      ...
      computedValue: {
        $ref: '#/definitions/attributeProperties/_computedValue'
      },
      target: {
      ...
      _schema: {
        $ref: '#/definitions/attributeProperties/_schema'
      },

      maximum: {
        $ref: '#/definitions/attributeProperties/_maximum'
      },
      minimum: {
        $ref: '#/definitions/attributeProperties/_minimum'
      },
      multipleOf: {
        $ref: '#/definitions/attributeProperties/_multipleOf'
      },
      maxLength: {
        $ref: '#/definitions/attributeProperties/_maxLength'
      },
      minLength: {
        $ref: '#/definitions/attributeProperties/_minLength'
      },
      exclusiveMaximum: {
        $ref: '#/definitions/attributeProperties/_exclusiveMaximum'
      },
      exclusiveMinimum: {
        $ref: '#/definitions/attributeProperties/_exclusiveMinimum'
      },
      pattern: {
        $ref: '#/definitions/attributeProperties/_pattern'
      },
      format: {
        $ref: '#/definitions/attributeProperties/_format'
      }
