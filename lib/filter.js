          ...
          if (key === '$and') {
            ...
            qbAnd.andWhere(qbSub => {
              ...
              newFilter.condition.map(({ targetAttribute, operator, sourceAttribute, value}) => {
                ...
                if (sourceAttribute) {
                  const sourceAttributeName = dataShaperMap[sourceAttribute] || sourceAttribute
                  buildWhereAttributeOperatorConditionQuery(subQuery, targetAttributeName, operator, sourceAttributeName, newFilter.entity, _placeholderIdx)
                }
                else {
                  buildWhereAttributeOperatorConditionQuery(subQuery, targetAttributeName, operator, value, newFilter.entity, _placeholderIdx)
                }
              })
            ...
            buildWhereAttributeConditionQuery(qbAnd, attributeName, newFilter, entityName, placeholderIdx)
          }
        })
