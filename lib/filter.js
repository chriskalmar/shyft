  ...
  qBuilder.andWhere(qbSub => {
    ...
    conditions.map(({ targetAttribute, operator, sourceAttribute, value }) => {
      ...
      if (sourceAttribute) {
        ...
        const sourceAttributeName = `${storageTableName}.${dataShaperMap[sourceAttribute] || sourceAttribute}`
...
export const buildWhereQuery = (qBuilder, filter, entityName, modelRegistry, isGetMany, transformFilterAttributeNameFn) => {
