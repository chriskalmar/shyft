...
export const StorageTypePostgres = new StorageType({
  ...
  findOne (entity, id, args, context, relayTypePromoterField) {
  ...
  async findOneByValues (entity, args, context, relayTypePromoterField) {
  ...
  async find (entity, args, context, relayTypePromoterField, parentConnection) {
  ...
  async mutate (entity, id, args, dataKey, entityMutation, context, relayTypePromoterField) {
    const entityName = entity.name
    const data = {
      ...args[ dataKey ]
    }
    ...
    const modelRegistry = this.getStorageModels()
    const sequelize = this.getStorageInstance()
    const { model, filterShaper } = modelRegistry[ entityName ]
