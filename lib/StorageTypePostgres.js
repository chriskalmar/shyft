...
export const transformFilterAttributeName = (context, entity) => i18nTransformFilterAttributeName(context, entity)
...
const createDataLoader = (context, entity, StorageTypePostgres) => {
  ...
  const loader = new Dataloader(async (ids) => {
    ...
    const transformFn = transformFilterAttributeName(context, entity, StorageTypePostgres)
...
export const StorageTypePostgres = new StorageType({
  ...
  async findOneByValues (entity, args, context) {
    ...
    const qBuilder = manager.createQueryBuilder(storageTableName, storageTableName)
    const transformFn = transformFilterAttributeName(context, entity, this)
