...
export const handlePermission = async (context, entity, permissionType, entityMutation, input) => {
  ...
  const permissionFilter = await buildPermissionFilter(permission, userId, userRoles, entity, input)
