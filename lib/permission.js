...
export const handlePermission = (context, entity, permissionType, entityMutation, mutationData) => {
  ...
  const permissionFilter = buildPermissionFilter(permission, userId, userRoles, entity, mutationData)
