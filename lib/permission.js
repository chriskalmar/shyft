...
export const handlePermission = async (context, entity, permissionType, entityMutation, mutationData) => {
  ...
  const permissionFilter = await buildPermissionFilter(permission, userId, userRoles, entity, mutationData)
