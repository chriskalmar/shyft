...
function getProviderEntityModel(providerName, domainName, entityName) {
...
function importDomainModel(domainModel, _providerName) {
  ...
  if (valid) {
    ...
    _.map(domainModel.entities, (entity) => {
      ...
      _.map(entity.attributes, (attribute) => {
