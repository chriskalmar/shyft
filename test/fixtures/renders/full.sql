...
SET client_min_messages TO WARNING;
  ...
  ;
create table "geo"."country" ("id" serial primary key, "created_at" timestamptz not null default CURRENT_TIMESTAMP, "updated_at" timestamptz not null default CURRENT_TIMESTAMP, "name" text, "iso_code" text, "continent" text);
